...
class viewproperty extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: propertyDetails(image1: Image.asset('assects/images/sunflower.jpg'),
